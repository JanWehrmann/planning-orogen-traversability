...
#ifndef TRAVERSABILITY_SIMPLE_TASK_HPP
...
namespace traversability {
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','traversability::Simple')
     end
     \endverbatim
    ...
    public:
         ...
         */
        Simple(std::string const& name = "traversability::Simple");
         ...
         * 
         */
        Simple(std::string const& name, RTT::ExecutionEngine* engine);

        /** Default deconstructor of Simple
         */
	~Simple();
